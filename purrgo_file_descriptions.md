...
include/purrgo/map.h интерфейс чтения и рендеринга карт PurrGo
...
src/core/gfx/gfx_renderer.c реализация графического контекста, цветов и вывода примитивов через callback
...
src/core/map.c реализация чтения IDX/MLP, обхода SQT/R-tree, пространственного отсечения, проекции и рендеринга карт
src/core/map_style.c таблица соответствия PurrGo feature code -> render style и выбор стиля объекта карты
...
tests/data/maps/map.name имя и метаданные тестового набора карты
...
tools/map-parser/ Python-инструменты разбора и подготовки карт
