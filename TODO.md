...
- [X] Реализовать STM32 SPI driver.
- [X] Реализовать файловую систему.
- [X] Реализовать структуру `/PURRGO/`.
- [ ] Перейти от SPI к SDIO.
- [ ] Реализовать управление питанием SD.
- [ ] Проверить power-up/power-down.
- [ ] Измерить ток потребления.
- [X] Проверить надёжность записи track при выключении питания.
...
- [X] Определить окончательное количество и расположение кнопок.
- [X] Проверить, достаточно ли четырёх встроенных кнопок Waveshare для основного интерфейса.
- [X] Реализовать основные экраны PurrGO.
- [X] Реализовать переключение режимов.
- [X] Реализовать отображение состояния GNSS.
