...
- [X] Выполнить полный audit map subsystem на `float` и `malloc`.
...
- [X] Реализовать RAM buffer для track points.
- [X] Накапливать точки блоками.
- [X] Минимизировать количество операций записи на SD.
