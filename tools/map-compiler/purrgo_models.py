...
_PGO_CHAR_MAP = {
    ...
    # Сведение типографских кавычек к стандартной машинной (0x22)
    '«': 0x22,  # левая ёлочка
    '»': 0x22,  # правая ёлочка
    '“': 0x22,  # левая английская / правая лапка
    '”': 0x22,  # правая английская
    '„': 0x22,  # левая лапка
    # Сведение типографских апострофов к стандартному (0x27)
    '’': 0x27,  # одинарная закрывающая
    '‘': 0x27,  # одинарная открывающая
    '`': 0x27,  # машинный обратный апостроф (гравис)
    '´': 0x27,  # акут
