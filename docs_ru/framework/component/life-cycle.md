...
Компоненты, страницы и приложения имеют жизненные циклы. Указанные функции можно вызывать на определенных этапах жизненного цикла объекта с помощью **функций жизненного цикла**.
