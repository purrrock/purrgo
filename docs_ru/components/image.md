...
Компонент изображения используется для отображения элементов изображения и по умолчанию центрируется. Компонент image по умолчанию является встроенным элементом.
