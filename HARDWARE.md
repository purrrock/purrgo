...
| **Платформа / MCU** | PC (`PURRGO_PLATFORM_PC`) | STM32F446RE (NUCLEO) | STM32U585CIU6 (`PURRGO_MCU_STM32U5`) |
| **GNSS-приемник** | MOCK (`PURRGO_GNSS_MOCK`) | GY-NEO6MV2 (u-blox NEO-6M) | u-blox серии M10 (MAX-M10S) |
| **Дисплей** | Эмулятор E-Ink | TFT 2.4" ST7789 (GMT024-08-SPI8P_LCM) | E-Ink 2.7" SPI |
| **Разрешение** | 176 × 264 px | 240 × 320 px | 176 × 264 px |
| **Диагональ** | 74 мм (~2.7") | 61 мм (2.4") | 74 мм (2.7") |
...
- **MCU:** STM32U585CIU6 (Cortex-M33, оптимизированное энергопотребление в режимах Stop/Standby, LP-таймеры, DMA).
...
- **Дисплей:** E-Ink 2.7", 176 × 264 px, 4 градации серого (2 bpp), интерфейс SPI. Читаемость на прямом солнечном свете, нулевое статическое потребление.
